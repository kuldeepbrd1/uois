...
class ESPModule(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, num_groups, ksize=1, add=True):
        ...
        self.conv1 = nn.Conv2d(
            in_channels, n, kernel_size=ksize, stride=1, padding=c1_padding, bias=False
        )

        self.dilated1 = nn.Conv2d(
            n, n1, kernel_size=3, stride=1, padding=1, bias=False, dilation=1
        )
        self.dilated2 = nn.Conv2d(
            n, n, kernel_size=3, stride=1, padding=2, bias=False, dilation=2
        )
        self.dilated4 = nn.Conv2d(
            n, n, kernel_size=3, stride=1, padding=4, bias=False, dilation=4
        )
        self.dilated8 = nn.Conv2d(
            n, n, kernel_size=3, stride=1, padding=8, bias=False, dilation=8
        )
        self.dilated16 = nn.Conv2d(
            n, n, kernel_size=3, stride=1, padding=16, bias=False, dilation=16
        )
